...
public class UserController {
    ...
    @PostMapping("")
    ResponseEntity<CreateUserResponse> signupUser(@Valid @RequestBody CreateUserRequest request) {
    ...
    @PostMapping("/login")
    ResponseEntity<Map<String,String>> loginUser(@Valid @RequestBody LoginUserRequest request) {
